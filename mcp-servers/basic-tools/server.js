...
// Create MCP server instance for basic tools
        ...
        contents: [
          {
            ...
            mimeType: 'application/json',
            text: JSON.stringify({
              serverName: 'basic-tools-mcp-server',
              version: '1.0.0',
...
async function main() {
  ...
  console.error('Basic Tools MCP Server started and listening on stdio');
}

main().catch((error) => {
  console.error('Failed to start Basic Tools MCP server:', error);
  process.exit(1);
}); 